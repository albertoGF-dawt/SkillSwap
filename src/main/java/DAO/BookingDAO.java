...
public class BookingDAO {
    ...
    public List<Booking> findByAlumno(int alumnoId) {
        EntityManager em = emf.createEntityManager();
        try {
            return em.createQuery("SELECT b FROM Booking b WHERE b.codAlumno.id = :alumnoId", Booking.class)
    ...
    public boolean isMentorshipAlreadyBooked(int mentorshipId) {
        EntityManager em = emf.createEntityManager();
        try {
            Long count = em.createQuery("SELECT COUNT(b) FROM Booking b WHERE b.codMentorship.id = :mentorshipId", Long.class)
    ...
    public List<Booking> findByMentorship(int mentorshipId) {
        EntityManager em = emf.createEntityManager();
        try {
            return em.createQuery("SELECT b FROM Booking b WHERE b.codMentorship.id = :mentorshipId", Booking.class)
                    .setParameter("mentorshipId", mentorshipId)
                    .getResultList();
        } finally {
            em.close();
    ...
    public List<Booking> findAllEager() {
        EntityManager em = emf.createEntityManager();
        try {
            return em.createQuery("SELECT b FROM Booking b JOIN FETCH b.codAlumno JOIN FETCH b.codMentorship m JOIN FETCH m.codMentor JOIN FETCH m.codSubject", Booking.class)
                    .getResultList();
        } finally {
            em.close();
        }
    ...
    public List<Booking> findByAlumnoEager(int alumnoId) {
        EntityManager em = emf.createEntityManager();
        try {
            return em.createQuery("SELECT b FROM Booking b JOIN FETCH b.codAlumno JOIN FETCH b.codMentorship m JOIN FETCH m.codMentor JOIN FETCH m.codSubject WHERE b.codAlumno.id = :alumnoId", Booking.class)
                    .setParameter("alumnoId", alumnoId)
                    .getResultList();
        } finally {
            em.close();
